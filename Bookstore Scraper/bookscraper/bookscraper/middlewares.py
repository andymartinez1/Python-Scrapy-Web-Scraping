...
# Middleware used to provide fake headers using ScrapeOps
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        request.headers["upgrade-insecure-requests"] = random_browser_header[
...
# Proxy service provided via Smartproxy
